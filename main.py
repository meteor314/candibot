...
def scan_page(page, phone, refresh_time_seconds, county):
    ...
    path = r"candibot/candibot/geckodriver"
...
def main():
    ...
    parser.add_argument('phone', nargs='?', default="+0000", type=str,
                        help='Phone number to send the notification to.')
    parser.add_argument('refresh_time_seconds', nargs='?', default=3, type=int,
                        help='Time to wait before refreshing the pahe (in seconds)')
    parser.add_argument('county', nargs='?', default=92, type=str, help='County number to scan')
    ...
    page = "https://beta.interieur.gouv.fr/candilib/candidat?token=" #your token

    scan_page(page, "0555", "10", "Gennevillers")
